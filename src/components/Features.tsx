...
{/*Feature 1 */}
      ...
      <Image src={Feature1} alt='Feature1' className='hidden w-1/2 sm:block'/>
        <div className='sm:w-1/2 lg:py-[56px] lg:pr-[56px]'>
          ...
          <p className='py-[24px] lg:text-[18px]'>Stay on top of things and revamp your work process with our game-changing feature. Get a birds eye view with our customizable dashboard.
          </p>
          <ul className='flex flex-col gap-y-3 lg:text-[18px]'>
            <li className='flex items-center gap-x-2'>
              <span><Image src={Check} alt='Check'/>Lorem ipsum dolor sit amet</span>
            </li>
            <li className='flex items-center gap-x-2'>
              <span><Image src={Check} alt='Check'/>Lorem ipsum dolor sit amet</span>
            </li>
...
{/*Feature 3 */}
      ...
      <Image src={Feature3} alt='Feature3' className='hidden w-1/2 sm:block'/>
        <div className='sm:w-1/2 lg:py-[56px] lg:pr-[56px]'>
          ...
          <h1 className='pt-[12px] text-2xl lg:text-[42px] lg:leading-[56px]'>Monitor your sites new subscribers </h1>
